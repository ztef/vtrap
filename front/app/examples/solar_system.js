...
//board.addElement({id:1, cliente:'A', ruta:'R1', mobil:'m2', tipo:'truck'});

//board.addElement({id:2, cliente:'B', ruta:'R1', mobil:'m2', tipo:'truck'});
//board.addElement({id:3, cliente:'C', ruta:'R2', mobil:'m3', tipo:'car'});
